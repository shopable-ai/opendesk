...
func TestParseManifestRejectsCoreGlobalsAndReservedNames(t *testing.T) {
	for _, namespace := range []string{"File", "System", "page", "NativeExtension", "window", "mouse", "keyboard", "clipboard", "App", "AppStorage", "Sound", "Audio", "SQLite", "ImageColor", "OCR", "Vision", "Screen", "ui"} {
