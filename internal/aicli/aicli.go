...
func registry() []command {
	return []command{
		...
		{Name: "run", Description: "Run a parameterized plain or protected JavaScript recipe with Execution.input and Execution.env.", Capability: "run", Arguments: []Argument{{Name: "recipe.js|recipe.odpkg", Type: "path", Required: true, Description: "Plain JavaScript recipe or protected recipe package."}, {Name: "--input", Type: "json", Description: "Inline JSON input."}, {Name: "--input-file", Type: "path", Description: "JSON input file."}, {Name: "--input-stdin", Type: "boolean", Description: "Read JSON input from stdin."}, {Name: "--env-file", Type: "path", Description: "Use one project environment file instead of .env and .opendesk.env."}, {Name: "--timeout", Type: "duration", Description: "Optional Go duration, for example 30s or 2m; defaults to the standard 30m execution timeout."}}, Handler: runCommand},
	}
}
