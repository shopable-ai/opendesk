...
func runCommand(ctx *Context) (any, *Error) {
	...
	request := pkgExecution.Request{ExecutionID: id, SourceLabel: "file:" + recipe, ScriptPath: recipe, Ext: ".js", ScriptHash: pkgExecution.ComputeScriptHash(source), ScriptContent: source, Input: input, WorkDir: workingDir, Environment: environment.Values, Timeout: *timeout, TimeoutMinutes: 30, EnableCommand: true, EnableDownload: true, EnableAccessibility: true, EnableSQLite: true, Artifacts: artifacts, Selection: pkgExecution.TerminalSelection{Mode: "quiet", Categories: map[string]bool{}}}
