...
func TestBuildWindowsFromInstalledTemplateStagesPortableDirectory(t *testing.T) {
	...
	for _, relative := range []string{"opendesk.exe", "opendesk-desktop.exe", "ui-host/opendesk-ui-host.exe", "polyfills/000.js", "jslibs/runtime.js", "app-mode/opendesk.app.json", "app-build-provenance.json"} {
...
func writeRuntimeTemplate(t *testing.T, target string) string {
	...
	writeFixture(t, root, "opendesk-desktop.exe", "desktop runtime")
