(function installPromotionsCore(root) {
  ...
  function validateCreative(input) {
    ...
    const value = {schemaVersion:2, id:input.id, campaignId:input.campaignId,
      ...
      title:mediaOnly ? text(input.title,'title',64,true) : text(input.title,'title',64),
      description:text(input.description,'description',120,true), cta:text(input.cta,'cta',16),
