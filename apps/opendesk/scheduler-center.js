...
return {ok: true, firedAt};`;
  ...
  const CSS = `
    ...
    main{height:100vh;padding:18px;display:flex;flex-direction:column;gap:11px;overflow:hidden}header{display:flex;justify-content:space-between;align-items:flex-start;gap:16px}header strong{font-size:22px}.header-actions{display:flex;align-items:center;gap:7px}.subtle{margin:5px 0 0;color:#999;font-size:12px}
