...
var jsMethodAllowlist = map[reflect.Type][]string{
	...
	reflect.TypeOf((*ImageColor)(nil)):     {"FindPos", "Diff", "LoadBase64", "Resize", "Clip", "Pixel", "FindColor", "FindColorBlocks", "HasColor", "IsGray", "GetSize", "Save", "FindRedChannel", "FindGreenChannel", "FindBlueChannel", "ToRGB", "ToRGBA", "ToHSL", "ToHSLA", "IsColorSimilar", "AnalyzeLayout"},
