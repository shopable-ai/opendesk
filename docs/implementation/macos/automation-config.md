...
open -n "$(pwd)/.runtime/build/macos-permission-bootstrap/Clawdesk.app" --args -mode all -keepalive 90s
```
...
open -n "$(pwd)/.runtime/build/macos-permission-bootstrap/Clawdesk Automation.app" --args "System Events"
```
