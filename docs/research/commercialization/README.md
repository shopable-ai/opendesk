...
10. [`opendesk-business-system-design.md`](opendesk-business-system-design.md)
    - 保存 2026-09-13 对话形成的七层商业系统、22 种经营机制和五套完整组合；
    - 区分预制能力、低摩擦调用、限额免费、首发共建、外包伙伴、私有交付与持续维护；
    - 将“押金返还”细化为即时优惠、服务额度、有条件现金返还和联合预购，明确销量风险与资金边界；
    - 拆开 24 小时接单、能力生产、无人值守执行和人工支持，以及首次配置与重复使用成本；
