...
const modules = {
  ...
  'flow-package': { file: 'suites/flow-package.js', exports: ["flowPackage"] },
  'flow-installation': { file: 'suites/flow-installation.js', exports: ["flowInstallation"] },
  'ai-runtime': { file: 'suites/ai-runtime.js', exports: ["aiRuntime"] },
  'assistant-task-core': { file: 'suites/assistant-task-core.js', exports: ["assistantTaskCore"] },
...
const modes = {
  ...
  "dialog": "dialog",
  "command": "commandGate",
  "flow-package": "flowPackage",
  "flow-installation": "flowInstallation",
  "ai-runtime": "aiRuntime",
  "assistant-task-core": "assistantTaskCore",
