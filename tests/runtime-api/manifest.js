...
globalThis.RuntimeAPIObjects = {
  page: { docs: 'docs/api/page.md', types: 'types/page.d.ts', source: 'automation/page.go + polyfills/000-page.js', status: 'stable', platforms: ['darwin', 'linux', 'windows'], methods: [
    ...
    'requestMacAutomationPermission',
  ...
  Webhook: {
    docs: 'docs/api/webhook.md', types: 'types/Webhook.d.ts',
    source: 'automation/webhook.go + polyfills/009-webhook.js', status: 'local',
    platforms: ['darwin', 'linux', 'windows'], authorization: 'trusted-local-script-app-ai', methods: ['listen'],
    example: 'examples/local-webhook-order-query/main.js',
    handle: { family: 'WebhookHandle', typeName: 'OpenDeskWebhookHandle', methods: ['requestHeaders', 'close'] },
  },
  ...
  ui: {
    ...
    methodMetadata: {
      toast: { source: 'polyfills/000-ui.js + automation/custom_ui_notify.go', docs: 'docs/api/notify.md' },
...
const unitBehavior = new Set([
  ...
  ...RuntimeAPIObjects.Webhook.methods.map((method) => 'Webhook.' + method),
  ...RuntimeAPIObjects.Webhook.handle.methods.map((method) => 'WebhookHandle.' + method),
...
globalThis.RuntimeAPITestFiles = {
  ...
  unit: [
    ...
    'tests/runtime-api/unit/webhook.test.js',
    ...
    'tests/runtime-api/unit/http-download.test.js',
