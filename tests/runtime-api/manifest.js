...
globalThis.RuntimeAPIObjects = {
  ...
  mouse: { docs: 'docs/api/mouse.md', types: 'types/mouse.d.ts', source: 'automation/mouse.go', status: 'stable', platforms: ['darwin', 'linux', 'windows'], methods: ['click', 'clickForPID', 'pressButtonForPID', 'move', 'down', 'up', 'getPos', 'wheel'] },
...
const restricted = {
  ...
  'mouse.pressButtonForPID': 'requires one uniquely named AXButton in a reviewed focused native window and Accessibility permission',
