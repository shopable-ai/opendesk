...
globalThis.RuntimeAPIObjects = {
  ...
  global: { docs: 'docs-user-api/polyfills.md', types: 'types/global.d.ts', source: 'polyfills', status: 'stable', platforms: ['darwin', 'linux', 'windows'], methods: [
    'notify', 'copyToClipboard', 'getClipboard', 'setTimeout', 'clearTimeout',
...
const unitBehavior = new Set([
  ...
  ...['setTimeout', 'clearTimeout', 'setInterval', 'clearInterval', 'sleep', 'sleepSeconds', 'requestAnimationFrame', 'cancelAnimationFrame'].map((method) => 'global.' + method),
]);
