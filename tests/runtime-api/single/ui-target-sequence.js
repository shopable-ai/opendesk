// Run from the repository root: ./dist/opendesk -script tests/runtime-api/single/ui-target-sequence.js -console-mode script
...
await runSelected('ui-target-sequence');
