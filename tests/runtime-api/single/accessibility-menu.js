// Run from the repository root: ./dist/opendesk -script tests/runtime-api/single/accessibility-menu.js -console-mode script
...
await runSelected('accessibility-menu');
