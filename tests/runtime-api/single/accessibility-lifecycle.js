// Run from the repository root: ./dist/opendesk -script tests/runtime-api/single/accessibility-lifecycle.js -console-mode script
...
await runSelected('accessibility-lifecycle');
