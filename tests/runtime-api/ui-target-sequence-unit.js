// Focused deterministic behavior gate for UI.tapTargets. It writes the normal
// unit envelope so exact-ID coverage can consume current-run evidence without
// claiming that unrelated unit families executed.
