...
def source_snapshot() -> dict[str, dict[str, object]]:
    ...
    for fixed in (
        ...
        ROOT / "scripts" / "test_runtime_apis.js",
        ROOT / "tests" / "runtime-api" / "gates" / "catalog-runner.js",
        ROOT / "tests" / "runtime-api" / "seams" / "async-fixture-session.sh",
        ROOT / "tests" / "runtime-api" / "seams" / "command-cancel.sh",
        ROOT / "tests" / "runtime-api" / "seams" / "custom-ui-session.sh",
        ROOT / "tests" / "runtime-api" / "seams" / "dialog-session.sh",
        ROOT / "tests" / "runtime-api" / "seams" / "environment-http-controller.js",
        ROOT / "tests" / "runtime-api" / "seams" / "environment-http-session.sh",
        ROOT / "tests" / "runtime-api" / "seams" / "live-fixture-session.sh",
