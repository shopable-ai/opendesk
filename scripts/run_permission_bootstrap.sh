...
SCREEN_APP="${ROOT_DIR}/.runtime/build/macos-permission-bootstrap/Clawdesk.app"
AUTOMATION_APP="${ROOT_DIR}/.runtime/build/macos-permission-bootstrap/Clawdesk Automation.app"
