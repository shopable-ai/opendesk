...
APP_ROOT="${ROOT_DIR}/.runtime/build/macos-permission-bootstrap/Clawdesk Automation.app"
SCRIPT_FILE="${ROOT_DIR}/.runtime/build/macos-permission-bootstrap/automation-bootstrap.applescript"
