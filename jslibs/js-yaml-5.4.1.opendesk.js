/*!
 * OpenDesk bundled adapter for js-yaml 5.4.1.
 * Upstream minified ESM distribution Git blob:
 * 79c6226ab1eb1f10550849d86285f3e86cd1fe5f
 * Verified identical in two independent GitHub repositories before vendoring.
 * Adaptation: wrap the unchanged parser/serializer body in an isolated scope,
 * remove only the final ESM export statement, and expose the stable YAML facade.
 * License: MIT; see jslibs/licenses/js-yaml-5.4.1-LICENSE.txt.
 */
(function (global) {
  'use strict';
