...
The committed `notify-demo.odflow` was generated by the repository's official `flow pack` command from this exact `main.js`, then passed `flow inspect`, `flow verify`, `flow install --trust-flow`, and `flow list` using an isolated app-data root. Installation/listing did not emit the fixed business console line.

The committed package has:

- archive SHA-256: `7e97b096f4919450f65dc6acfac419006a609f290a70c94041cdc7e32b6a86f1`
- manifest SHA-256: `61fc44a4b8106696171b157a17af816fcd2af3aedd294df9ed3d2e557c967efb`
- publisher fingerprint: `8b2e9dd083270a0ea3a3fc4be404bf912a0a6942acedd5e624e7c567e0f38bc6`

The checked-in `flow.json` was extracted from that exact archive. It is generated metadata, not a second authoring source; `main.js` plus the documented `flow pack` arguments remain the rebuild inputs.
