const pageExampleDir = '.runtime/temp/examples';
File.ensureDir(pageExampleDir);
...
await page.screenshot({
    path: `${pageExampleDir}/page-script-screenshot.png`
});

await page.screenshot({
    path: `${pageExampleDir}/page-script-screenshot-cut.png`,
    clip: {
      x: 100,       // 截图区域的x坐标
      y: 100,       // 截图区域的y坐标  
      width: 500, // 截图区域的宽度
