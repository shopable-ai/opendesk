...
declare global {
  ...
  interface ClawdeskUIControlState {
    ...
    /** Current validated image source for img controls. */
    source?: string;
    value?: unknown;
    checked?: boolean;
    active: boolean;
    ...
    visible: boolean;
    classes?: string[];
    /** Browser/native decode completion for img controls. */
    imageComplete?: boolean;
    /** Decoded intrinsic image width for img controls; 0 with imageComplete=true means decode/load failure. */
    imageNaturalWidth?: number;
    /** Decoded intrinsic image height for img controls; 0 with imageComplete=true means decode/load failure. */
