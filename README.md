...
## CLI 模式运行脚本文件
go run ./cmd/clawdesk -script examples/test.js -delay 1

go run ./cmd/clawdesk -script examples/page.js
go run ./cmd/clawdesk -script examples/mouse.js
go run ./cmd/clawdesk -script examples/keyboard.js
go run ./cmd/clawdesk -script examples/screenshot.js

go run ./cmd/clawdesk -script examples/http.js -delay 1
go run ./cmd/clawdesk -script examples/promise.js -delay 1
go run ./cmd/clawdesk -script examples/timer.js
go run ./cmd/clawdesk -script examples/sleep.js
go run ./cmd/clawdesk -script examples/notify.js
go run ./cmd/clawdesk -script examples/window.js -delay 2
go run ./cmd/clawdesk -script examples/window-more.js
go run ./cmd/clawdesk -script examples/clipboard.js
go run ./cmd/clawdesk -script examples/appStorage.js
go run ./cmd/clawdesk -script examples/screen.js
go run ./cmd/clawdesk -script examples/sound.js
go run ./cmd/clawdesk -script examples/file.js
go run ./cmd/clawdesk -script examples/os.js


go run ./cmd/clawdesk -script examples/clipboard.test.js

go run ./cmd/clawdesk -script examples/globalThis.js
...
go run ./cmd/clawdesk -script examples/imageColor.js
go run ./cmd/clawdesk -script examples/opencv.js
go run ./cmd/clawdesk -script examples/vision.ocr.js
go run ./cmd/clawdesk -script examples/mac/screenshot_permission_check.js
go run ./cmd/clawdesk -script examples/mac/request-macos-permissions.js
go run ./cmd/clawdesk -script examples/mac/request-macos-automation-popup.js
go run ./cmd/clawdesk -script examples/mac/automation-permission-wizard.js

### CLI 视觉模式（不启动 HTTP）
go run ./cmd/clawdesk -vision-ocr-image test.png -vision-provider paddle -vision-lang ch
go run ./cmd/clawdesk -vision-detect-ui-image test.png -vision-target-text 发送 -vision-provider paddle -vision-lang ch
...
go run ./cmd/clawdesk -script examples/app/pinduoduo.js
go run ./cmd/clawdesk -script examples/app/qianniu.js

### libs
go run ./cmd/clawdesk -script examples/moment.js

go run ./cmd/clawdesk -script examples/start.js -timeout 0   # 无超时时限，默认 -timeout 30 分钟

go run ./cmd/clawdesk -http   # 启动 HTTP 服务器模式

### macOS 权限稳定运行（推荐）

排障手册（建议收藏）：
- `docs/desktop-automation/macos-remote-clawdesk-runbook.md`
- `docs/macos-screenshot-troubleshooting.md`
- `docs/macos_automation_config.md`
...
go run ./cmd/clawdesk -script examples/test.txt -delay 1  # 后期未使用，可能无法使用
...
cmd/clawdesk/    # 主 CLI/HTTP 可执行入口及其同包白盒测试
